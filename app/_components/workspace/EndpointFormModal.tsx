        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="flex space-x-2 mb-3">
                  ...
                  <button
                    type="button"
                    onClick={addHeader}
                    disabled={createEndpoint.isPending || !headerInput.key || !headerInput.value}
          ...
          <div className="flex items-center justify-between pt-4 border-t border-white/10">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                type="submit"
                disabled={createEndpoint.isPending || !formData.name.trim() || !formData.url.trim() || currentEndpoints >= maxEndpoints}
